...
public class RecipeServiceImpl implements RecipeService {
    ...
    public List<Recipe> getFilteredRecipe(MultiValueMap<String, String> filters) {
        return StreamSupport.stream(recipeRepository.findAll(SearchCriteriaBuilder.addCondition(filters)).spliterator(), false)
    ...
    @Override
    public Recipe findRecipeById(String recipeId) throws ResourceNotFoundException {
        return recipeRepository.findById(recipeId).orElseThrow(() -> new ResourceNotFoundException("Recipe not found for this id :: " + recipeId));
    }
