...
public class RecipeServiceTest {
    ...
    public void shouldReturnListOfRecipes() {
        ...
        List<Recipe> recipes = new ArrayList<>(
            Arrays.asList(new Recipe("0", "Fried egg with tomato", 2, TestUtil.getIngredients("egg", "tomato"), "crack the egg on the pan with little oil.", Category.NON_VEGETARIAN),
                ...
                new Recipe("2", "salmon with potato", 4, TestUtil.getIngredients("salmon", "potato"), "at 250 degree celcium grill the fish along with potato in the oven", Category.NON_VEGETARIAN)
            ));
    ...
    public void shouldReturnListOfRecipeWithFilter_ExcludeSalmon_HasOven() {
        ...
        List<Recipe> recipes = new ArrayList<>(
            Arrays.asList(new Recipe("2", "grilled with potato", 4, TestUtil.getIngredients("potato"), "at 250 degree celcium grill the potato in the oven", Category.VEGETARIAN)));
    ...
    public void shouldReturnListOfRecipeWithFilter_Serving4_IncludesPotato() {
        ...
        List<Recipe> recipes = new ArrayList<>(
            Arrays.asList(new Recipe("4", "grilled with potato", 4, TestUtil.getIngredients("potato"), "at 250 degree celcium grill the potato in the oven", Category.VEGETARIAN)));
        Mockito.when(recipeRepository.findAll(Mockito.any(Predicate.class))).thenReturn(recipes);
        List<Recipe> foundedRecipes = recipeService.getFilteredRecipe(paramsMap);
        Assertions.assertEquals(1, foundedRecipes.size());
