...
public class RecipeControllerIntegrationTest {
    ...
    List<Recipe> recipes = new ArrayList<>(
      Arrays.asList(
        new Recipe( "0", "Fried egg with tomato", 2, TestUtil.getIngredients("egg", "tomato"),
          "crack the egg on the pan with little oil. And bake in oven for 2 minutes.",
  ...
  public void testGetAllRecipes() {
    ...
    ResponseEntity<String> response = restTemplate.exchange(getRootUrl() + "/recipes", HttpMethod.GET, entity, String.class);
  ...
  public void testGetFilteredRecipe_AllVegetarian() {
    ...
    recipes.forEach(recipe -> assertEquals(recipe.get("category"), "VEGETARIAN"));
  }
  ...
  public void testCreateRecipe() {
    Recipe recipe = new Recipe("5", "Fried egg with tomato", 2, TestUtil.getIngredients("potato"),
  ...
  public void testMergePatchRecipe_forServings() {
    ...
    ResponseEntity<Void> updatedRecipe = restTemplate.exchange("/recipes/" + id, HttpMethod.PATCH, new HttpEntity<>(TestUtil.fromFile("merge-patch.json"), headers),
      Void.class, id);
  ...
  public void testPatchRecipe_forCategory() {
    ...
    ResponseEntity<Void> updatedRecipe = restTemplate.exchange("/recipes/" + id, HttpMethod.PATCH, new HttpEntity<>(TestUtil.fromFile("json-patch.json"), headers),
      Void.class, id);
